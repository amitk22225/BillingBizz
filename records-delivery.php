...
<head>
    ...
    <title>Delivery Challan Records</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="records-list">
            ...
            $result = $con->query("SELECT * FROM deliverychallan WHERE comname = '" . $_SESSION['comname'] . "' AND $criteria LIKE '%$searchTerm%' ORDER BY CHALLAN_DATE DESC");

            while ($row = $result->fetch_assoc()) {
                echo '<div class="record-item">';
                echo '<p>Customer Name: ' . $row['CNAME'] . '</p>';
                echo '<p>Customer Email: ' . $row['customeremail'] . '</p>';
                echo '<p>Challan No.: ' . $row['CHALLAN_NO'] . '</p>';
                echo '<p>Challan Date: ' . $row['CHALLAN_DATE'] . '</p>';

                echo '<a href="printchallan.php?id= ' . $row['SID'] . ' &ACTION=VIEW" class="material-icons mx-3" style="text-decoration: none;">&#xe8a0;</a>';
                echo '<a href="printchallan.php?id= ' . $row['SID'] . ' &ACTION=EMAIL" class="material-icons mx-3" style="text-decoration: none;">&#xe0be;</a>';
                echo '<a href="printchallan.php?id= ' . $row['SID'] . ' &ACTION=DOWNLOAD" class="material-icons mx-3" style="text-decoration: none;">&#xe2c4;</a>';
                echo '<a href="printchallan.php?id= ' . $row['SID'] . ' &ACTION=DELETE" class="material-icons mx-3" style="text-decoration: none;">&#xe872;</a>';
