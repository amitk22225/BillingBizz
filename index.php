    ...
    <div class='container'>
      ...
      <?php
        ...
        //   $itype=mysqli_real_escape_string($con,$_POST["itype"]);
          ...
          $sql="insert into invoicee (INVOICE_NO,INVOICE_DATE,PLACESUPPLY,CNAME,CADDRESS,CCITY,SNAME,SADDRESS,SCITY,GRAND_TOTAL,comname,customeremail) values ('{$invoice_no}','{$invoice_date}','{$placesupply}','{$cname}','{$caddress}','{$ccity}','{$sname}','{$saddress}','{$scity}','{$grand_total}','{$_SESSION['comname']}','{$customeremail}') ";
          if($con->query($sql)){
            $sid=$con->insert_id;
      ...
      <form method='post' action="" autocomplete='off' >
        <div class='row'>
          ...
          <div class='col-md-4'>
            ...
            <div class='form-group'>
              <label>Name</label>
              <input type='text' name='cname' id='cname' required class='form-control'>
            </div>
            <div class='form-group'>
              <label>Address</label>
