...
<html>
  ...
  <body>
    ...
    <div class='container'>
      ...
      <div class = "sentence"> <p> Quotation </p></div>
    </div>
      <?php
        ...
        //   $saddress=mysqli_real_escape_string($con,$_POST["saddress"]);
          ...
          $sql="insert into quotation (INVOICE_NO,INVOICE_DATE,PLACESUPPLY,CNAME,CADDRESS,CCITY,GRAND_TOTAL,comname,customeremail,tandc) values ('{$invoice_no}','{$invoice_date}','{$placesupply}','{$cname}','{$caddress}','{$ccity}','{$grand_total}','{$_SESSION['comname']}','{$customeremail}','{$tandc}') ";
          if($con->query($sql)){
            $sid=$con->insert_id;
            
            $sql2="insert into quotation_products (SID,PNAME,hsn,PRICE,QTY,sgst,cgst,TOTAL) values ";
            $rows=[];
     ...
     <form method='post' action="<?php echo $_SERVER['PHP_SELF']; ?>" autocomplete='off'>
        <div class='row'>
          ...
          <div class='col-md-4'>
            ...
            <div class='form-group'>
              <label>Customer/Client Email</label>
    ...
    <input type='submit' name='submit' value='Generate Quotation' class='btn btn-success float-right'>
</div>
