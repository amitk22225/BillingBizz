...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
    <title>Dashboard | Invoice Maker</title>
...
<body>
  <div class="sidebar">
    <div class="logo-details">
      ...
      <span class="logo_name">Invoice Maker</span>
    </div>
      <ul class="nav-links">
        <li>
          <a href="#" class="active">
        ...
        <li>
          <a href="records1.php">
            <i class='bx bx-coin-stack' ></i>
            <span class="links_name">Delivery Records</span>
          </a>
        </li>
        <li>
          <a href="#">
  ...
  <section class="home-section">
    <nav>
      ...
      <div class="profile-details">
        <i class="admin_name">Welcome, <?php echo $_SESSION['comname'] ?></i>      
      </div>
    </nav>
