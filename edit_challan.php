...
$query = "select * from deliverychallan where SID ='{$_GET["id"]}'";
...
<div class='container'>
    ...
    if(isset($_POST["submit"])){
        ...
        $sql="UPDATE deliverychallan SET 
        ...
        <div class='row'>
            <div class='col-md-4'>
                ...
                <div class='form-group'>
                    ...
                    <input type='text' name='challan_no' value="<?php echo $challan_no; ?>" required class='form-control'>
                </div>
                <div class='form-group'>
                    <label>Challan Date</label>
                    <input type='text' name='challan_date' value="<?php echo $challan_date; ?>" id='date' required class='form-control'>
                </div>
                <div class='form-group'>
                ...
                <div class='form-group'>
                    ...
                    <input type='text' name='transportmode' value="<?php echo $transportmode; ?>" id='transportmode' required class='form-control'>
                </div>
                <div class='form-group'>
                    <label>Vehicle Number</label>
                    <input type='text' name='vehiclenumber' value="<?php echo $vehiclenumber; ?>" id='vehiclenumber' required class='form-control'>
                </div>
            </div>
            <div class='col-md-4'>
